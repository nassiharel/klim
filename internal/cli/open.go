...
var openCmd = &cobra.Command{
	...
	Long: `Install tools from a compact share token generated by 'klim share link'.
...
Usage:
  klim share link open klim:v1:H4sIAAAA...          # interactive
  klim share link open klim:v1:H4sIAAAA... --yes    # non-interactive`,
	Args: requireArgs(1, "klim share link open <token>"),
	RunE: runOpen,
}
