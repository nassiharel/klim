...
description: How to contribute a new tool to the clim catalog
---

import { Steps } from '@astrojs/starlight/components';

The clim marketplace is open source — anyone can add a tool by submitting a PR.
...
4. **Submit a PR** to the clim repository.
</Steps>
