...
description: Use .klim.yaml to standardize developer tools across your team
---

import { Steps } from '@astrojs/starlight/components';

A `.klim.yaml` file defines the tools your project requires, with optional version constraints. Drop it in your repository root and every developer can verify their setup with a single command.
...
Use `klim check` in your CI pipeline to fail fast if tools are missing:
