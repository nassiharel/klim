...
Custom packs are stored at `~/.config/klim/marketplace/custom-packs.yaml`.

## Backup Storage

Exported backups are saved to:
- **macOS:** `~/Library/Application Support/klim/backups/`
- **Linux:** `~/.config/klim/backups/`
- **Windows:** `%AppData%\klim\backups\`
