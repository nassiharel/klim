---
title: Quick Start
description: Get up and running with klim in minutes
---

import { Steps } from '@astrojs/starlight/components';

This guide walks you through using klim for the first time.
...
klim will scan your `$PATH` to discover installed developer tools, then display them in an interactive interface with version information and update status.
...
3. Team members run: `klim check` to verify they have all required tools
