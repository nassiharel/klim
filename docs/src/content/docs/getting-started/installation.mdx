---
title: Installation
description: How to install klim on macOS, Linux, and Windows
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

klim supports macOS, Linux, and Windows across both amd64 and arm64 architectures.
...
Head to the [Quick Start](/getting-started/quickstart) guide to start using klim.
