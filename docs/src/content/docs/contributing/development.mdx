---
title: Development
description: How to build, test, and lint clim
---
...
The binary is output to `bin/clim` with version/commit/date injected via ldflags.
...
| `make build` | Build `bin/clim` with version ldflags |
...
See the [Architecture](/contributing/architecture) page for the full module layout and data flow.
