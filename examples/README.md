...
```bash
klim check                 # see what's missing vs this contract
klim install               # install everything the contract requires
klim diff teammate.yaml    # compare against another machine
```
